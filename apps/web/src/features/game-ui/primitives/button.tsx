...
const buttonVariants = cva(
   ...
   rounded-[var(--nv-r-sm)] border text-sm font-medium
   focus-visible:ring-2 focus-visible:ring-[color:var(--nv-focus-ring)]
 ...
 `,
	{
     ...
     `,
				danger:
					`
       border-[rgba(255,111,136,0.5)] bg-[rgba(255,111,136,0.14)]
       text-[#ffd4dd]
