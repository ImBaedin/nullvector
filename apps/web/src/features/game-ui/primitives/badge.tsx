...
const badgeVariants = cva(
 ...
 `,
    ...
    `,
				info: `
      border-[rgba(126,201,255,0.6)] bg-[rgba(126,201,255,0.16)] text-[#d8edff]
    `,
				success: `
      border-[rgba(100,248,187,0.58)] bg-[rgba(100,248,187,0.14)] text-[#cdfce8]
    `,
				warning: `
      border-[rgba(255,209,102,0.62)] bg-[rgba(255,209,102,0.16)] text-[#fff0be]
    `,
				danger: `
      border-[rgba(255,111,136,0.62)] bg-[rgba(255,111,136,0.18)] text-[#ffd8e0]
    `,
			},
		},
