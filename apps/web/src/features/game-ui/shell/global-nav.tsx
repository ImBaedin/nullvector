...
export function GlobalNav({
  ...
  return (
    <div className="relative z-[var(--nv-z-popover)] isolate grid grid-cols-[1fr_auto_1fr] items-center gap-3 px-4 py-3">
      <div className="flex items-center gap-3 justify-self-start">
        <img
          alt="Nullvector logo"
          className="h-11 w-11 rounded-md border border-[color:var(--nv-glass-highlight)] bg-[rgba(255,255,255,0.05)] object-contain p-1"
        ...
        <div>
          ...
          <h1 className="nv-display text-[color:var(--nv-text-primary)] text-xl font-semibold">
            {title}
          </h1>
        </div>
      </div>
      ...
      <div className="justify-self-center">
        ...
        >
          ...
          <img
            alt="Star map icon"
            className="relative z-10 h-6 w-6 object-contain drop-shadow-[0_0_8px_rgba(61,217,255,0.55)]"
