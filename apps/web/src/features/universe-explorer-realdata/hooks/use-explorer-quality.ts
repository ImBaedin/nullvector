...
export function useExplorerQuality() {
  const [qualityPreset, setQualityPresetState] =
    useState<ExplorerQualityPreset>("auto");
  const [gpuQualityHint, setGpuQualityHint] =
    useState<ExplorerResolvedQuality | null>(null);
