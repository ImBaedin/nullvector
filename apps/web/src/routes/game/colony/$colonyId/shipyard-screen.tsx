	...
	return (
		<article
			className={`
             ...
             ${availability.lockedByLevel ? "border-white/8 opacity-60 grayscale" : "border-white/10"}
		...
		>
			...
			<div className="relative z-10 p-3 sm:p-4">
				<div className="flex items-center gap-3">
                   ...
                   text-[8px] font-semibold whitespace-nowrap uppercase
		...
		<div className="flex items-center rounded-lg border border-white/12 bg-black/25">
			...
			<input
				className="
                   ...
                   font-(family-name:--nv-font-mono) text-xs font-bold text-white outline-none
...
function ActiveQueueCard(props: {
	...
	return (
		<div className="space-y-3">
			<p className="text-[10px] font-semibold tracking-[0.14em] text-white/45 uppercase">Active</p>
			<div
				className="
